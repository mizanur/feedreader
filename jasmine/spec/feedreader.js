...
$(function() {
    ...
    describe('RSS Feeds', function() {
         ...
         * page?
         */
        it('should have allFeeds are defined', function() {
    ...
    describe('Initial Entries', function() {
         ...
         */
        it('should contain a feed element async', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        it('should change feed content after loading feed', function(done) {
            loadFeed(1, function() {
                $feedNodeTwo = $('.feed').html();
                expect($feedNodeTwo).not.toEqual($feedNodeOne);
                done();
            });
        });
    });
